...
\begin{document}
  ...
  % palavras-chave
  \palchaves{CGNAT.\; SSL VPN.\; Controle de acesso.\; Regras de firewall.}

  \resumo{Os provedores de acesso à internet tem o desafio de manter ininterrupto o serviço de rede aos assinantes, garantindo velocidade e estabilidade na conexão. Embora esse seja o objetivo comercial dessas empresas, existem vários problemas operacionais que demandam da atenção dos administradores da rede para garantir pleno funcionamento da operadora. Um dos problemas enfrentados é a escassez de endereços IPv4, que impõe limitações na conectividade à internet. Outro problema tange à segurança da rede, uma vez que dispositivos conectados estão suscetíveis a ataques, que podem comprometer a disponibilidade do serviço. O objetivo deste trabalho em particular foi desenvolver soluções para problemas que envolvem a conectividade dos assinantes à internet, obedecendo a lei do Marco Civil da Internet e mantendo os acordos cooperativos firmados entre os sistemas autônomos e o CERT.br para manutenção da segurança da internet brasileira. No trabalho foi feito dimensionamento de uma rede IPv4 e implementado CGNAT  como recurso à escassez de endereços (enquanto o IPv6 não é uma tecnologia de ponta-a-ponta), além de ter sido utilizado dos recursos de segurança computacional aplicados às redes para controle de acesso, utilizando-se de firewall e de VPN para limitar o acesso a equipamentos conforme o princípio do privilégio mínimo, bem como foram aplicados bloqueios em conexões suspeitas para mitigar ataques de negação de serviço. O trabalho possibilitou o aprofundamento prático na área de Sistemas de Computação, especificamente nos assuntos de Redes, Sistemas Distribuídos e Segurança Computacional, servindo de ponte entre a academia e o conhecimento técnico-científico utilizado no mercado. As atividades deste trabalho foram desenvolvidas como estágio supervisionado no centro de operações de rede da Minasnet Telecomunicações Ltda, operadora de internet que presta serviço em 21 cidades no sul de Minas Gerais.
}
